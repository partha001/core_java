package com.partha.problemSolving.mapRelated;

import java.util.HashMap;

/**
 * @problemStatement: implement LeastRecentlyUsed Cache using hashmap
 * @author parbiswa
 *
 */
public class LRUCache {
	...
	public static void main(String[] args) throws java.lang.Exception {
		...
		//this will return -1 since the value is removed
		System.out.println(lrucache.getEntry(1));
		//this will return 16 as that is the last updated value
