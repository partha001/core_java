...
public class Program3AccessingFieldValues {
    ...
    public static <T> void printDeclaredFieldsInfo(Class<? extends T> clazz, T instance) throws IllegalAccessException {
        for (Field field : clazz.getDeclaredFields()) {
            ...
            field.setAccessible(true); //otherwise reading from private attributes will give error
            System.out.println(String.format("field value is : %s", field.get(instance))); //reading the value
