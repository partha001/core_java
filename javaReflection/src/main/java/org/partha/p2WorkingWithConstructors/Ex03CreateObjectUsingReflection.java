...
/**
 * this program is an extension to the previous program. the limitation with
 * Ex02CreateObjectUsingReflection is that its not fully generic. since whereever we are calling
 * createInstanceWithArguments we have to do manual type-casting.
 * this problem can be solved using generics as shown below
...
public class Ex03CreateObjectUsingReflection {
    ...
    public static void main(String[] args) throws InvocationTargetException, InstantiationException, IllegalAccessException {
        ...
        Address address = createInstanceWithArguments(Address.class, "school road", 19);
