...
import org.partha.p5WorkingWithMethods.ex4.database.DatabaseClient;
import org.partha.p5WorkingWithMethods.ex4.http.HttpClient;
import org.partha.p5WorkingWithMethods.ex4.logging.FileLogger;
import org.partha.p5WorkingWithMethods.ex4.udp.UdpClient;
...
/**
 * this program shows how we are calling methods from different classes using reflection
 * which have nothing in common .
 *
 * this is possible using reflection and generics . here were leveraging the fact that all
 * classes are subclass of the Object class
 */
public class Ex04MethodInvocation {
