...
/**
 * problemStatement: size of a binary tree i.e. given a binary tree get the total
 * number of node in the tree
 * referred from : https://www.youtube.com/watch?v=NA8B84DZYSA
 * @author parbiswa
 *
 */
public class SizeOfABinaryTree {
	...
	public static void main(String[] args) {
		...
		System.out.println(getSize(tree1.root));
