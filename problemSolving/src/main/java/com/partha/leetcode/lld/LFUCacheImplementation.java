...
public class LFUCacheImplementation {
	...
	private static class LFUCache1 {


	    private final Map<Integer, CachedElement<Integer, Integer>> elements; 	    // map for all elements	    
	    private final TreeMap<Integer, LinkedList<Integer>> frequencies = new TreeMap<>(); // sorted map for elements grouped by frequencies and querying by frequency    
