...
public class CombinationSum2 {
    ...
    private static class Solution1 {
        ...
        public void combination(int[] candidates, int target, List<List<Integer>> result, List<Integer> current,
            ...
            for (int i = start; i < candidates.length; i++) {
                ...
                if (i > start && candidates[i] == candidates[i - 1]) //this is the condition that gets added newly on top of combinationSum1
                    continue; // this is basically to avoid duplicates
